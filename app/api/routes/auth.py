...
from app.api.schemas.user import UserCreate, UserLogin, VerifyCodeRequest, ResetPasswordRequest, Token, \
    UserProfileResponse, UserUpdateRequest
from app.api.crud.user import get_user_by_phone, get_user_by_username, create_user, authenticate_user, \
    create_verify_code, verify_code, reset_password, get_user_by_id, update_user
...
def register(user: UserCreate, db: Session = Depends(get_db)):
    ...
    if user.role == "visitor":
        avatar = "/static/river/1.jpg"
    elif user.role == "merchant":
        avatar = "/static/river/2.jpg"

    user = create_user(db, user, avatar)
...
#
#     if user.role == "visitor":
#         user.avatar = "/static/river/1.jpg"
#     elif user.role == "merchant":
#         user.avatar = "/static/river/2.jpg"
#
